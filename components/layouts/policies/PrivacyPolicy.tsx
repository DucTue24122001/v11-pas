      ...
      {language === "MY" &&  (
        ...
        >
          <Box>
            ...
            <Text>
              {tenancy?.appName} သည် ကစားသမားများ၏ ကိုယ်ရေးကိုယ်တာအချက်အလက်များကို
            ...
            <Text>
              ဤကိုယ်ရေးကိုယ်တာမူဝါဒသည် {tenancy?.appName} ၏ စည်းမျဉ်းသတ်မှတ်ချက်
          ...
          <Box>
            ...
            <Text>
              {tenancy?.appName} ကို အသုံးပြုသည်နှင့်တစ်ပြိုင်နက် ကစားသမားများ၏
