      ...
      {language === "MY" && (
        ...
        >
          ...
          <Box>
            <Text>
              <span style={headList}>1. </span>
              “{tenancy?.appName} စည်းမျဉ်းများ” သည် အကောင့်ဖွင့်သူ သင်နှင့် {tenancy?.appName}
              ထိန်းချုပ်သူများအကြား ပြီးပြည့်စုံကာ ညီမျှသည့် သဘောတူညီချက်များကို
              ဖော်ပြသည့် စည်းကမ်းသတ်မှတ်ချက်များဖြစ်ပါသည်။ {tenancy?.appName}အကောင့်ကို
            ...
            <Text ml={"10px"}>
              ...
              {tenancy?.appName} စည်းမျဉ်းများ၏ အဖွဲ့ဝင်ဖြစ်ပါမည်။
            </Text>
            <Text ml={"10px"}>
          ...
          <Box>
            <Text>
              ...
              {tenancy?.appName}သည် ၎င်း၏ စည်းမျဉ်းများကို အချိန်မရွေး အပ်ဒိတ်လုပ်ခြင်း၊
              ပြင်ဆင်ခြင်း၊ တည်းဖြတ်ခြင်းနှင့် ဖြည့်စွက်ခြင်းများ
              ပြုလုပ်နိုင်ပါသည်။ {tenancy?.appName} စည်းမျဉ်းများဆိုင်ရာ များပြားလှသော
              ပြင်ဆင်ချက်မှန်သမျှ မလုပ်ဆောင်မီ {tenancy?.appName}အကောင့်ပိုင်ရှင်ထံ
              ကြိုတင်အကြောင်းကြားမည်ဖြစ်ပြီး သင်၏ခွင့်ပြုချက် လိုအပ်မည်ဖြစ်သည်။
              {tenancy?.appName}စည်းမျဉ်းများ ပြင်ဆင်ချက်များကို သဘောမတူပါက
              ဝန်ဆောင်မှုများကို ဆက်လက်အသုံးပြုခွင့် မပြုပါ။ {tenancy?.appName}
          ...
          <Box>
            <Text>
              ...
              အကောင့်ဖွင့်ခြင်းအားဖြင့် {tenancy?.appName}နှင့် စာချုပ်အရ ပတ်သက်မှုရှိမည်
              ဖြစ်ပါသည်။
            </Text>
          </Box>
          <Box>
            <Text>
              ...
              {tenancy?.appName}အကောင့်သည် {tenancy?.appName}နှင့်
          ...
          <Box>
            <Text>
              ...
              စာချုပ်သည် {tenancy?.appName}နှင့် အကောင့်ကိုင်ဆောင်သူကြားရှိ
              စာချုပ်ဆိုင်ရာ ဆက်ဆံရေးဖြစ်ပြီး {tenancy?.appName}
            ...
            <Text ml={"10px"}>
              ...
              ယခုလက်ရှိ {tenancy?.appName}နှင့် သက်ဆိုင်သည့်
            ...
            <Text ml={"10px"}>
              <span style={headList}>(ခ)</span>
              “ဝန်ဆောင်မှု” ဆိုသည်မှာ {tenancy?.appName}မှတစ်ဆင့်
            ...
            <Text ml={"10px"}>
              ...
              အက်ပလီကေးရှင်းကို လည်ပတ်ရန်အတွက် {tenancy?.appName}မှ အသုံးပြုသည့်
            ...
            <Text ml={"10px"}>
              ...
              အက်ပလီကေးရှင့်နှင့် ၎င်းတွင်ပါရှိသော ပစ္စည်းတို့သည် {tenancy?.appName}နှင့်
              {tenancy?.appName}၏ ထောက်ပံ့သူများနှင့် ပါတနာများ၏
          ...
          <Box>
            <Text>
              ...
              ကစားသမားအဖြစ် စာရင်းသွင်း၍ မရသည့်အပြင် {tenancy?.appName}အကောင့်ကို
              ကိုင်ဆောင်၍မရပါ။ {tenancy?.appName}သည် ဂိမ်းတွင် ပေးထားသည့်
              အချက်အလက်များကို အတည်ပြုရန်အတွက် လိုအပ်သော အသက် အထောက်အထားကို
              တောင်းဆိုရန်နှင့် စစ်ဆေးမှုများ လုပ်ဆောင်ရန် အခွင့်ရှိပါသည်။
              လုံလောက်သော အသက်အထောက်အထား မပြနိုင်မချင်း {tenancy?.appName}အကောင့်ကို
          ...
          <Box>
            <Text>
              ...
              {tenancy?.appName} ကစားသမားများက ပေးအပ်သော ကိုယ်ရေးကိုယ်တာနှင့်
              လျှို့ဝှက်အချက်အလက်များအားလုံးကို {tenancy?.appName}တွင်
              လျှို့ဝှက်ထားရှိပြီး သုံးစွဲသူများ၏အတွေ့အကြုံကို
              မြှင့်တင်ရန်အတွက်သာ {tenancy?.appName} စနစ်တွင်သာ အသုံးပြုမည်ဖြစ်ပြီး
          ...
          <Box>
            ...
            <Text ml={"10px"}>
              <span style={headList}>(ခ) </span>
              {tenancy?.appName}မှ ကမ်းလှမ်းသည့် ပြိုင်ပွဲများ၏ ကြေးစားကစားသမားများ
              မဖြစ်ရ။
            </Text>
            <Text ml={"10px"}>
              <span style={headList}>(ဂ)</span>
            ...
            <Text ml={"10px"}>
              <span style={headList}>(ဇ) </span>
              {tenancy?.appName}အကောင့်အား ရာဇ၀တ်မှုဆိုင်ရာ လှုပ်ရှားမှုများတွင်
              တိုက်ရိုက်ဖြစ်စေ၊သွယ်ဝိုက်၍ဖြစ်စေ ပါဝင်ပတ်သက်ခြင်း မပြုရ။
            </Text>
            <Text ml={"10px"}>
              <span style={headList}>(ဈ)</span>
              {tenancy?.appName}အဖွဲ့၏ အစိတ်အပိုင်းဖြစ်သည့်
